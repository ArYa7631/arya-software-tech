                ...
                <div>
                    ...
                    <ul className="py-2">
                        {profileLinkData.map((item) => (
                            <li>
                                <Link key={item.name} href={item.href} onClick={item.id ? logoutHandler : () => { }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">{item.name}</Link>
                            </li>
